...
document.querySelectorAll('.image_overlay').forEach(function(button) {
    button.addEventListener('mouseover', function() {
        ...
        var add_to_cart_button = document.getElementById("add_to_cart_" + this.getAttribute('value'));

        var layout = document.getElementById(this.getAttribute('id'));

        var word = document.getElementById("stats-container_" + this.getAttribute('value'));

        var description = document.getElementById("product-options_" + this.getAttribute('value'));
...
document.querySelectorAll('.add_to_cart.increaseButton').forEach(function(button) {
    button.addEventListener('mouseover', function() {
